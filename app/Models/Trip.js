...
export class Trip {
  ...
  get Template() {
    return /*html*/ `
    <h2 class=" text-center text-light p-2" onclick="" aria-current="page">${
      this.title
        ...
        <thead>
          <tr>
            ...
            <button type="button"  data-bs-toggle="modal"  data-bs-target="#reservation${
              this.id
            ...
            <div class="row">
                  <h5 class="modal-title" id="exampleModalLabel">Reservation Form</h5>
                    <form class="modal-body" id="form" onsubmit="app.reservationsController.addReservation('${this.id}')">
                      <div class="col-md-12">
    ...
    <textarea class="form-control"onblur="app.tripsController.updateTripNote('${
      this.id
    }')" placeholder="Trip Notes Here" id="floatingTextarea" ></textarea>
